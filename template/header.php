...
<body>
  ...
  <header class="jumbotron bgColorCharcoalBlue">
    <h1>DEV BANK</h1>
    <p class="lead"> &lt; <span class="baliseBlue">une banque</span> &gt;, mais <span class="baliseRed">flex</span>;</p>
    <nav id="burger">
      <i class="fas fa-bars colorHoneyYellow"></i>
    </nav>
  </header>
  <nav class="bgColorQueenBlue" id="navBar"> 
    <ul class="nav">
      <li class="nav-item ">
        <a class="nav-link active colorHoneyYellow" href="index.php">Accueil</a>
      </li>
      <li class="nav-item">
        <a class="nav-link colorHoneyYellow" href="statistics.php">Statistique</a>
      </li>
      <li class="nav-item">
